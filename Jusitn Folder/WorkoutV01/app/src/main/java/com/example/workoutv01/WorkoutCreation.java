...
public class WorkoutCreation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.workout_creation);
        ...
        RouteSpinner = findViewById(R.id.WorkoutCreationSpinnerRouteType001);
        ...
        DistanceType = findViewById(R.id.spinnerDistanceType);
    ...
    public void launchSettings (View s){
        ...
        String message = ((EditText)findViewById(R.id.WorkoutCreationEditTextNumberSigned001)).getText().toString();
